...
function preload()
{
  ...
  emptystar = loadImage('g_star1.png');
...
function setup() 
{
  ...
  STAR = createSprite(270,50);
  STAR.addImage(star);
  STAR.scale = 0.02;

  
  STAR1 = createSprite(50,350);
  STAR1.addImage(star);
  STAR1.scale = 0.02;

  
  STAR3 = createSprite(50,30);
  STAR3.addImage(emptystar);
  STAR3.scale = 0.07;

  STAR4 = createSprite(100,30);
  STAR4.addImage(emptystar);
  STAR4.scale = 0.07;
